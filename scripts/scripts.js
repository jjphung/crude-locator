$(document).ready(function() {
    ...
    // STATIC MAP DEMO
    // $('.map').attr('src', 'https://maps.googleapis.com/maps/api/staticmap?center=28.0173, -82.7461&zoom=13&scale=2&size=200x300&maptype=roadmap&format=png&visual_refresh=true&markers=size:small%7Ccolor:0xff0000%7Clabel:1%7C28.0173, -82.7461');
